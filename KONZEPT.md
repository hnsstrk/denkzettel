...
- **Zielplattform:** KDE Plasma unter Wayland (Ganymed: Plasma 6.7, Qt 6.11)
...
- **Whisper-Backend wählbar in den Einstellungen** (Vault-Recherche 31.07.2026,
  ...
  Auf Ganymed sind zwei GPU-taugliche Wege belegt — **whisper.cpp** mit ROCm-/
  ...
  *(Korrektur 31.07.2026 abends, Befund der Schätzklausur: WhisperX ist auf
  Ganymed noch **nicht installiert** — geplant im RPG-Audio-Projekt, der PoC
...
- **Standard-Kürzel: Meta+N (Text-Capture), Meta+Umschalt+N (Sprachnotiz).**
  Auf Ganymed gegen die KDE-Belegung geprüft (31.07.2026): beide frei; Meta-Kürzel
