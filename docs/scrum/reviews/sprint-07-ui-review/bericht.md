...
| **P5** | **Dem unteren Rand der Hülle fehlt eine Gerätezeile.** 174 logische Bildpunkte bei 1,6 sind 278,4; die Fläche hat 278, die Grafik wird mit 279 gerendert. Die unterste Zeile des Grabs ist wertgleich mit der zweitobersten — die zarteste Zeile des unteren Bogens kommt nicht vor. Belegt im Alphakanal, Abschnitt 1a. Der Betrag ist eine halbe Gerätezeile und wechselt mit der Fensterhöhe das Vorzeichen; mit Schatten ist im Bild nichts davon zu sehen, alle schattenweiten Eckläufe stimmen mit KRunner überein | **ok** | Nur festhalten. Eine Heilung hieße, die Fensterhöhe auf ganze Gerätebildpunkte zu runden — das griffe in die Höhenrechnung von #56 ein und kostete mehr, als es einbrächte |
